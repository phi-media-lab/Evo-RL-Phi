...
VALUE_RUN_DIR="$REPO_ROOT/outputs/value_train/pi05_acp_ckpt_meanstd"
VALUE_INFER_DIR="$REPO_ROOT/outputs/value_infer/pi05_acp_smoke"
POLICY_RUN_DIR="$REPO_ROOT/outputs/train/pi05_acp_policy_smoke"
