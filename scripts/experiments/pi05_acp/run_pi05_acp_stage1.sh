...
VALUE_RUN_DIR="$REPO_ROOT/outputs/value_train/pi05_acp_stage1"
VALUE_INFER_DIR="$REPO_ROOT/outputs/value_infer/pi05_acp_stage1"
POLICY_RUN_DIR="$REPO_ROOT/outputs/train/pi05_acp_policy_stage1"
